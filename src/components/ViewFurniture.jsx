      ...
      <div className="min-h-screen bg-gray-50 flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-gray-600">
            The furniture item you're looking for doesn't exist.
          </p>
        </div>
      </div>
    );
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 p-8">
            ...
            <div className="space-y-6">
              <div>
                ...
                <p className="text-gray-600">{furniture.category?.name}</p>
              </div>
              ...
              <div className="border-t border-gray-200 pt-6">
                <button
                  onClick={() => {
                    const shareText = `Check out this furniture from New Vishwakarma Furniture: ${furniture.name}`;
                  ...
                  className="flex items-center justify-center gap-2 bg-amber-500 hover:bg-amber-600 text-white font-medium py-3 px-6 rounded-lg transition-colors duration-200 shadow-md"
                >
                  <svg
                    className="w-5 h-5"
                    fill="none"
