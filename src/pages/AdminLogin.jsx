          ...
          <div className="w-full max-w-sm">
            ...
            <form onSubmit={handleSubmit} className="space-y-4 sm:space-y-6">
              ...
              <button
                type="submit"
                disabled={loading}
                className={`w-full flex justify-between items-center py-3 sm:py-4 px-6 rounded-xl text-base sm:text-lg font-semibold transition-all shadow-md ${
                  loading
                    ? "bg-gray-400 cursor-not-allowed"
                    : "bg-gradient-to-r from-[#8B7355] to-[#A89276] text-white hover:-translate-y-0.5"
                }`}
              >
