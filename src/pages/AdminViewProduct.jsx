      ...
      <div className="max-w-6xl mx-auto bg-white shadow-md rounded-xl sm:rounded-2xl p-4 sm:p-6 lg:p-8 border border-gray-100">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 sm:gap-8">
          ...
          <div className="space-y-4 sm:space-y-6">
            ...
            {/* ✅ Dimensions */}
            <div className="flex flex-col sm:flex-row gap-3 text-gray-700 mt-3">
              <div className="bg-gray-50 px-4 py-2 rounded-md border text-sm sm:text-base">
            ...
            <div className="border-t border-gray-200 pt-4">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4 text-xs sm:text-sm">
                ...
                <div>
                  ...
                  <span className="ml-2 text-gray-900">
                    {new Date(furniture.updatedAt).toLocaleDateString() ||
                      "N/A"}
                  </span>
                </div>
              </div>
