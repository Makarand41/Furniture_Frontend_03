...
const Stock = () => {
  ...
  const statusOptions = ["Ordered", "Delivered", "Pending"]; // Optional frontend-only dropdown
  ...
  const buildImageUrl = (path) => {
    ...
    return `http://localhost:8081/${cleaned}`; // ✅ Local backend
  };
    ...
    <div className="min-h-screen bg-gray-50 py-6 px-3 sm:px-6 lg:px-10">
      <div className="max-w-7xl mx-auto bg-white shadow-lg rounded-xl p-4 sm:p-6 lg:p-8">
        ...
        <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-6">
          <h2 className="text-2xl font-bold text-gray-800">📦 Furniture Stock Overview</h2>
          <button
        ...
        <div className="overflow-x-auto">
          <table className="w-full border text-left text-sm">
            <thead>
              <tr className="bg-amber-800 text-white text-sm">
            ...
            <tbody>
              {items.map((f) => {
                ...
                return (
                  <tr key={f.id} className="border-b hover:bg-gray-100 transition">
                    <td className="p-3">
                      {img ? (
                        <img
                          src={img}
                    ...
                    {/* ✅ Height & Width (text-based like “3ft”) */}
